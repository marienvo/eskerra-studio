...
| `--color-app-chrome-surface` | `color-mix(in srgb, var(--color-app-chrome-backdrop) 85%, white)` | Mostly theme, hint of white — pressed pane-toggle **icon** (reads like the chrome bar). |
